	...
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (entity.getPersistentData().getBoolean((StringArgumentType.getString(arguments, "home_name"))) == true) {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal(("[ Oxygene ] Vous avez \u00E9t\u00E9 t\u00E9l\u00E9port\u00E9 \u00E0 votre home "
						+ StringArgumentType.getString(arguments, "home_name"))), (false));
		} else {
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal(("[ Oxygene ] Le home \"" + "" + StringArgumentType.getString(arguments, "home_name")
