...
public class SethomeprocessProcedure {
	public static void execute(double x, double y, double z, CommandContext<CommandSourceStack> arguments, Entity entity) {
		if (entity == null)
			return;
		if (entity.getPersistentData().getBoolean("Has_ssh") == false) {
			entity.getPersistentData().putBoolean("Has_ssh", (true));
			entity.getPersistentData().putDouble("number_home", 0);
		}
		...
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(Component.literal("[ Oxygene ] Le home \u00E0 \u00E9t\u00E9 creer a votre position actuel"), (false));
	}
}
