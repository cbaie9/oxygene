...
public class SpawnprocessProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((dim == 0 || dim == 2 || dim == 1) && (world.getBlockState(new BlockPos(0, 10, 0))).getBlock() == OxygeneModBlocks.REGISTRYBLOCK.get()) {
			dim_id = new Object() {
			...
			}.getValue(world, new BlockPos(0, 10, 0), "spawn_dim");
			if ((dim_id).equals("0")) {
				if (!((entity.level.dimension()) == (Level.OVERWORLD))) {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal("/spawn : Dimension non pris en charge"), (false));
		}
	}
}
